...
<div class="card">
    <div class="card-header">
        <h4><i class="fas fa-edit"></i> Modifier une note</h4>
    </div>
    <div class="card-body">
        <form:form action="${pageContext.request.contextPath}/notes/modifier"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <form:select path="inscription.id" class="form-select" disabled="true">
                    ...
                    <form:hidden path="inscription.id"/>
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label">Matière</label>
                    <form:select path="matiere.id" class="form-select" disabled="true">
                        <c:forEach items="${matieres}" var="m">
                            <form:option value="${m.id}">${m.code} - ${m.nom}</form:option>
                        </c:forEach>
                    </form:select>
                    <form:hidden path="matiere.id"/>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <form:input path="moyenne" class="form-control" readonly="true"/>
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label">Mention</label>
                    <form:input path="mention" class="form-control" readonly="true"/>
                </div>
